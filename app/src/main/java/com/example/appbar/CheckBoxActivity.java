    ...
    private void initViews() {
        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String info = mInputInfo.getText().toString();
                final String money = mInputMoney.getText().toString();
                String sourceOfPaymant = "";

                if(mBankCardChkBx.isChecked()) {
                    sourceOfPaymant = mBankCardChkBx.getText().toString();
                }
                if(mMobilePhoneChkBx.isChecked()) {
                    sourceOfPaymant = mMobilePhoneChkBx.getText().toString();
                }
                if(mCashAddressChkBx.isChecked()) {
                    sourceOfPaymant = mCashAddressChkBx.getText().toString();
                }

                StringBuilder sb = new StringBuilder();
                sb.append("Произведена оплата в сумме " + money).append('\n')
                        .append(sourceOfPaymant + " ").append(info);

                Toast.makeText(CheckBoxActivity.this, sb.toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
